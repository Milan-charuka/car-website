...
const scrollUp = () => {
    ...
    this.scrollY >= 350 ? scrollUp.classList.remove('show-scroll')  : scrollUp.classList.add('show-scroll')
} 
...
const scrollActive = () => {
    const scrollYDown = window.scrollY
    ...
    sections.forEach(current => {
        ...
        if(scrollYDown > sectionTop && scrollYDown <= sectionTop + sectionHeight){
